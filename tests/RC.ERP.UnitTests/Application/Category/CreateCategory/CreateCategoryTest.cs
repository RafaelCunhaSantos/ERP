...
using Xunit;
using UseCases = RC.ERP.Application.UseCases.Category.CreateCategory;
using DomainEntity = RC.ERP.Domain.Entity;
using FluentAssertions;
using RC.ERP.Application.UseCases.Category.CreateCategory;
using RC.ERP.Domain.Exceptions;

namespace RC.ERP.UnitTests.Application.Category.CreateCategory
{
